...
public class GraphicsMock extends Graphics {
	...
	ArrayList<GameImage> imageBuffer;
	
	public GraphicsMock() {
		super();
		// TODO Auto-generated constructor stub
		textBuffer = new ArrayList<GameText>();
		imageBuffer = new ArrayList<GameImage>();
	}
	...
	public ArrayList<GameImage> getImageBuffer() {
		return imageBuffer;
	}
	...
	public void drawString(String str, int x, int y) {
		...
		textBuffer.add( new GameText(str, x, y) );
	}
	
	@Override
	public boolean drawImage(Image img, int x, int y, ImageObserver observer) {
		// TODO Auto-generated method stub
		imageBuffer.add( new GameImage( (BufferedImage)img, x, y) );
		return false;
	}
